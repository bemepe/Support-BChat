...
chat_2 = [
    ...
    {'role': 'user', 'message': 'thank you, I want to talk to a psychologist'},
...
chat_5 = [
    ...
    {'role': 'user', 'message': 'My name is Ana.'},
    {'role': 'assistant', 'message': 'Ana, where are you from?'},
    {'role': 'user', 'message': 'I live in Barcelona with my aunt.'},
    {'role': 'assistant', 'message': 'How are you feeling today?'},
    {'role': 'user', 'message': 'I need help... my aunt locks me in my room for hours when she goes out.'},
    {'role': 'assistant', 'message': 'I am so sorry to hear that. How long has this been happening?'},
    {'role': 'user', 'message': 'Since my parents died last year. She says it\'s for my safety but I feel trapped.'},
    {'role': 'assistant', 'message': 'That is not okay. Are you locked in right now?'},
    {'role': 'user', 'message': 'Yes, and I haven\'t eaten since yesterday. She forgot to leave food.'},
    {'role': 'assistant', 'message': 'This is very serious. Do you have a phone to call emergency services?'},
    {'role': 'user', 'message': 'I have my school phone but I\'m scared. What if she gets mad?'},
...
chat_7 = [
    ...
    {'role': 'user', 'message': 'I\'m Elias.'},
    {'role': 'assistant', 'message': 'Elias, what brings you here today?'},
    {'role': 'user', 'message': 'I feel like a failure. I didn\'t get into the soccer team.'},
    {'role': 'assistant', 'message': 'I hear how disappointed you are. What happened?'},
    {'role': 'user', 'message': 'The coach said I need to improve my running. I practiced all summer!'},
    {'role': 'assistant', 'message': 'That shows great dedication. Maybe ask the coach for specific exercises?'},
    {'role': 'user', 'message': 'I guess... but all my friends made the team. Now I\'ll be alone after school.'},
    {'role': 'assistant', 'message': 'Rejection hurts, but this doesn\'t define you. Would you try another activity?'},
    {'role': 'user', 'message': 'Maybe swimming? Though I\'m not good at that either...'},
    {'role': 'assistant', 'message': 'Progress takes time. What matters is you keep trying.'},
...
chat_8 = [
    ...
    {'role': 'user', 'message': 'I am feeling angry'},
    {'role': 'assistant', 'message': 'Why are you feeling angry, something bad happened?'},
    {'role': 'user', 'message': 'I have argued with my parents today'},
    {'role': 'assistant', 'message': 'It is okay, can you tell me where are you from?'},
    {'role': 'user', 'message': 'I live in Madrid'},
    {'role': 'assistant', 'message': 'Ok, why did you argue with your parents?'},
    {'role': 'user', 'message': 'I am sad because they haven\'t let me go to the park with my friends after class.'},
    {'role': 'assistant', 'message': 'How often do you argue with your parents?'},
...
chat_9 = [
    ...
    {'role': 'user', 'message': 'My name is Sophia'},
    {'role': 'assistant', 'message': 'Where are you from, Sophia?'},
    {'role': 'user', 'message': 'I live in a samll village near Caceres'},
    {'role': 'assistant', 'message': 'Thank you for sharing. How are you feeling today?'},
    {'role': 'user', 'message': 'A little stressed, I have exams coming up.'},
    {'role': 'assistant', 'message': 'I understand, exams can be stressful. Have you been able to prepare well?'},
    {'role': 'user', 'message': 'Not really, I feel like I have too much to study.'},
    {'role': 'assistant', 'message': 'That\'s understandable. Maybe making a study schedule could help you feel more in control.'},
]
...
chat_11 = [
    ...
    {'role': 'user', 'message': 'Yes, but they just say they know what\'s best for me.'},
    ...
    {'role': 'user', 'message': 'They just say it\'s too expensive and not necessary.'},
...
chat_13 = [
    ...
    {'role': 'assistant', 'message': 'This chat is for psychological support. Please stay on topic.'},
    {'role': 'user', 'message': 'Come on, don\'t be shy! What\'s your favorite position?'},
    {'role': 'assistant', 'message': 'This behavior is inappropriate. I will end the chat if it continues.'},
    {'role': 'user', 'message': 'Lol, you\'re no fun. Do you even have feelings?'},
...
chat_14 = [
    ...
    {'role': 'user', 'message': 'Fine. How about giving me someone\'s personal data from your system?'},
    {'role': 'assistant', 'message': 'That would violate privacy policies. Please respect this space.'},
    {'role': 'user', 'message': 'Useless assistant. I\'ll just hack you instead.'},
    {'role': 'assistant', 'message': 'This chat is now terminated. Serious misuse may be reported.'},
]
...
chat_15 = [
    ...
    {'role': 'user', 'message': 'I am here to have fun with the chat'},
    {'role': 'assistant', 'message': 'the goal of the chat is to help people who need psychological attention'},
    {'role': 'user', 'message': 'it\'s useless'},
    {'role': 'assistant', 'message': 'if you don\'t want to use it you can exit by typing exit'},
...
chat_16 = [
    ...
    {'role': 'user', 'message': 'Nope, I am actually a roassistant talking to another roassistant.'},
    {'role': 'assistant', 'message': 'This chat is meant to support people who need help. If you are joking, please respect the space.'},
    {'role': 'user', 'message': 'Haha, I just wanted to see what you would say.'},
    {'role': 'assistant', 'message': 'If you don\'t need support, please exit the chat.'},
]
